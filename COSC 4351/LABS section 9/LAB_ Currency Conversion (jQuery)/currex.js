...
var allCurrencies = {
  ...
  "BGN": "Bulgarian Lev",
  "BHD": "Bahraini Dinar",// Mapping of all currency abbreviations to full currency name
  "AED": "United Arab Emirates Dirham",
  "AFN": "Afghan Afghani",
  "ALL": "Albanian Lek",
  "AMD": "Armenian Dram",
...
$(document).ready(function() {
  // Update options in toCurrency select element
  ...
  // Convert currency when toCurrency select element changes
  ...
  $('#toCurrency').change(function() {
    ...
    var usdValue = parseFloat(usdInput.val());
    var toCurrency = $('#toCurrency').val();
    var exchangeRate = exchangeRates.rates[toCurrency];
    var resultCurrencyValue = usdValue * exchangeRate;
    resultCurrencyInput.val(resultCurrencyValue.toFixed(2));
    var toCurrencyName = allCurrencies[toCurrency];
    resultCurrencyLabel.text(toCurrencyName + ' (' + toCurrency + '):');
  });

  // Update rates when Update Rates button is clicked
  $('#updateRates').click(function() {
    var exchangeRatesTextarea = $('#exchangeRates');
    var newExchangeRates = JSON.parse(exchangeRatesTextarea.val());
    exchangeRates = newExchangeRates;
    // Re-populate toCurrency select element
    var rates = exchangeRates.rates;
    var toCurrencySelect = $('#toCurrency');
    toCurrencySelect.empty();
    toCurrencySelect.append($('<option>', {
    ...
    // Reset resultCurrency input and label
    resultCurrencyInput.val('---.--');
    resultCurrencyLabel.text('To Currency ():');
  });
});
